...
#[derive(Debug, Clone)]
pub struct Graph {
    pub data: HashMap<(u32, u32), (f32, f32, f32, Box<Vec<Option<f32>>>)>,
...
impl Graph {
    ...
    pub fn add_node(
        &mut self,
        key: (u32, u32),
        value: (f32, f32, f32, Box<Vec<Option<f32>>>)
    ) {
    ...
    pub fn get(
        &self,
        key: &(u32, u32),
    ) -> Option<&(f32, f32, f32, Box<Vec<Option<f32>>>)> {
        self.data.get(&key)
    }
...
impl Graph {
    ...
    pub fn neighbours(
        ...
        j_ngb: &[i32],
        factor: f32,
        node_mapping: &HashMap<(i32, i32), (u32, f32, Box<Vec<Option<f32>>>)>,
        transform: &Affine,
        is_wgs: bool,
    ) -> bool {
...
impl Graph {
    ...
    pub fn fringe(
        ...
        level: i32, 
        node_mapping: &HashMap<(i32, i32), (u32, f32, Box<Vec<Option<f32>>>)>,
        node_mapping_higher: &HashMap<(i32, i32), (u32, f32, Box<Vec<Option<f32>>>)>,
